...
class MazeSolver {
    ...
    findPath(startX, startY, endX, endY) {
        ...
        while (currentCell != null) {
            ...
            const unvisitedConnectedNeighbors = connectedNeighbors.filter((cell) => !cell.visited)
